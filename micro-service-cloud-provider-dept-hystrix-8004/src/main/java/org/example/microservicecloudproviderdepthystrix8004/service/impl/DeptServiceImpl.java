package org.example.microservicecloudproviderdepthystrix8004.service.impl;

import com.netflix.hystrix.contrib.javanica.annotation.HystrixCommand;
import com.netflix.hystrix.contrib.javanica.annotation.HystrixProperty;
import org.example.microservicecloudproviderdepthystrix8004.service.DeptService;
...
public class DeptServiceImpl implements DeptService {
  ...
  @HystrixCommand(fallbackMethod = "deptCircuitBreaker_fallback", commandProperties = {
      ...
      @HystrixProperty(name = "circuitBreaker.requestVolumeThreshold", value = "1"), //统计时间窗内请求次数
